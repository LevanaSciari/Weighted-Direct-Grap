...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	private static JMenuBar createMenuBar() {
		...
		JMenuItem menuItem3 = new JMenuItem("isConnected");
		JMenuItem menuItem4 = new JMenuItem("shortestPathDist");
		JMenuItem menuItem5 = new JMenuItem("shortestPath");
		...
		JMenu menu3 = new JMenu("Node");
		menuBar.add(menu3);
		JMenuItem menuItem7 = new JMenuItem("addNode");
		JMenuItem menuItem8 = new JMenuItem("removeNode");
		menuItem7.addActionListener(std);
		menuItem8.addActionListener(std);
		menu3.add(menuItem7);
		menu3.add(menuItem8);

		JMenu menu4 = new JMenu("Edge");
		menuBar.add(menu4);
		JMenuItem menuItem9 = new JMenuItem("connect");
		JMenuItem menuItem10 = new JMenuItem("removeEdge");
	...
	private double path(StringBuilder sb) {
		...
		if(gui.getAlgo().shortestPath(src, dest)==null) 
			...
			ArrayList<node_data> lista = (ArrayList<node_data>) gui.getAlgo().shortestPath(src, dest);
		...
		return (gui.getAlgo().shortestPathDist(src, dest));
